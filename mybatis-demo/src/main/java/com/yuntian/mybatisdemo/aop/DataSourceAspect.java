package com.yuntian.mybatisdemo.aop;

/**
 * @author guangleilei.
 * @date Created in 17:19 2019/11/14
 * @description
 */

import com.yuntian.mybatisdemo.config.DataSourceAnnotation;
import com.yuntian.mybatisdemo.config.DataSourceContextHolder;
...
public class DataSourceAspect {
     ...
     * 切点, 注意这里是在service层
     */
    @Pointcut("execution(* com.yuntian.mybatisdemo.service..*.*(..)))")
    public void aspect() {
    }
